...
public class UserController {
    ...
    @GetMapping("/users/{id}")
    public ResponseEntity<?> findOneUser(@PathVariable Integer id) {
    try {
    ...
    public ResponseEntity<?> updateOneUser(@PathVariable Integer id, @RequestBody Map<String, Object> updates) {
        try {
            Optional<User> optionalUser = this.userRepository.findById(id);
