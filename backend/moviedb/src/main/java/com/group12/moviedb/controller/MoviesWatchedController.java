...
public class MoviesWatchedController {
    ...
    public List<MoviesWatched> getMoviesWatchedById(@PathVariable("user_id") int userId) {
    ...
    public List<MoviesWatched> getMoviesWatchedByMovieId(@PathVariable("movie_id") int movieId) {
