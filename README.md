...
Käyttäjät voivat rekisteröityä palveluun, kirjautua oalle tiilleeen ja kirjautua tililtä ulos. Julkiset (ei-autentikoidut) käyttäjät pääsevät projektin julkisille sivuille.
